...
const {location,mapsUrl} = getTournamentLocationInfo();
  ...
  ? `https://tournifyapp.com/live/${window.tournamentInfo.liveLink}/referee/${window.selectedTeam.id}`
...
pdf.text(
  [
    ...
    '',
    'Additional Day 2 assignments may be added later.',
    '',
